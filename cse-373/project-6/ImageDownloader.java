...
public class ImageDownloader {
    public static void main(String[] args) {
        ...
        Packet[] testPackets = PacketReceiver.receivePackets(10);
        // TODO: Sort the packets by calling one of your methods
        GenericSorter.mergeSort(testPackets, new PacketComparator());
        String imageOutputFilename = "sImage.jpg";
        // TODO: Make the correct call to render the images
        PacketRenderer.renderImage(testPackets, imageOutputFilename);
    }
